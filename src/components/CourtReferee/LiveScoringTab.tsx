...
import {
  ...
  ChevronDown,
  AlertTriangle,
  History,import React, { useState, useEffect, useRef } from 'react';
import {
  RotateCcw,
  ShieldAlert,
  Zap,
...
export const LiveScoringTab: React.FC<LiveScoringTabProps> = ({ onBackToSetup }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4 pb-12">
      ...
      {/* YENİ: DİKKAT ÇEKİCİ AYARLARA GERİ DÖN BUTONU */}
      <button
        type="button"
        onClick={onBackToSetup}
        className="w-full py-4 bg-slate-800 hover:bg-slate-700 border-2 border-slate-700 rounded-2xl flex items-center justify-center gap-3 text-slate-200 font-black shadow-lg transition active:scale-95"
      >
