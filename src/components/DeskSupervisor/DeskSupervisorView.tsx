...
export const DeskSupervisorView: React.FC = () => {
 ...
 if (confirm('KRİTİK UYARI: Telefondaki önbellek, yerel hafıza ve buluttaki (Firestore) TÜM MAÇLAR kökten silinecektir! Yeni günün programını yüklemeden önce her şeyi sıfırlamak istediğinize emin misiniz?')) {
 setIsSyncingAction(true);
 setImportMsg('🔄 Bulut veritabanı ve önbellek kökten temizleniyor...');
 const success = await clearLocalCacheAndResetFromCloud();
 setIsSyncingAction(false);
 if (success) {
 setImportMsg('✨ Tüm turnuva geçmişi ve bulut başarıyla temizlendi! Yeni JSON yükleyebilirsiniz.');
 } else {
