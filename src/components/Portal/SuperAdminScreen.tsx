...
import {
  Plus, Trash2, LogOut, Trophy, Save, X, Shield, Eye, EyeOff, RefreshCw
} from 'lucide-react';
import {
      ...
      <main className="max-w-5xl mx-auto px-4 py-6 space-y-8">
        ...
        <section>
          ...
          <div className="space-y-2">
            {tournaments.map(t => (
              <div key={t.id} className="flex items-center gap-3 p-4 bg-slate-900 border border-slate-700/60 rounded-xl">
                ...
                <button onClick={() => handleTurnuvaSil(t)}
                  className="p-2 text-rose-400/60 hover:text-rose-300 hover:bg-rose-950/30 rounded-lg transition shrink-0">
        ...
        <section>
          ...
          <div className="space-y-2">
            {(config?.bashakem_listesi || []).map(bh => {
              ...
              return (
                <div key={bh.id} className="flex items-center gap-3 p-4 bg-slate-900 border border-slate-700/60 rounded-xl">
